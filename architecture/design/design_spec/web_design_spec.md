...
- 디자인 스킬: <https://github.com/uxjoseph/supanova-design-skill> 참조해서 사용
...
- 최우측 상단: 보고서 ID, 보고서 생성일시, 비교국 스냅샷 일자 정보 노출 + 보고서 PDF 다운로드 버튼
- 중간 영역: 탭으로 구분
...
- 최우측 상단: 보고서 ID, 보고서 생성일시 + 보고서 PDF 다운로드 버튼
- 중간 영역: 탭으로 구분
  - 요약, 시장, 규제, 상품, 시스템
  - 각 탭 영역별로 적절한 레이아웃 구성 필요
